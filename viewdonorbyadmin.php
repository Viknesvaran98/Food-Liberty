...
<link rel="shortcut icon" href="images/logo/favicon.ico" type="image/x-icon" />
    ...
    <title>View Donor's Profile</title>
                            ...
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    ...
                                    <div><?php
                                     ...
                                     {
                                       ?>
                                <?php echo $row['donorfullname']; ?> 's Profile
                                <?php }}?>
...
<center>
  ...
  <br>
      <p class="food-menu-box p1"><mark><label>ID: <?php echo $row['donor_ID']; ?></label></mark></p>
      <input type="hidden" name="donorimage" id="donorimage" value="<?php echo $row['donorimage']?>"/>
      
      <div class="food-menu-img">
                    <img width="auto" src="images/<?php echo $row['donorimage']?>" class="img-responsive img-curve" width="450" height="200">
                </div>
                <hr size="4" width="80%" color="yellow">  <br>
    <div class="food-box">
      <div class="col-md-12 p1"><label class="labels">Username</label>: <?php echo $row['username']?></div><br>

      <div class="col-md-12 p1"><label class="labels">Name</label>: <?php echo $row['donorfullname']?></div><br> 

      <div class="col-md-12 p1"><label class="labels">Password</label>: <?php echo $row['password']?></div><br> 
      
      <div class="col-md-12 p1"><label class="labels">Contact Number</label>: <?php echo $row['donorcontact_num']?></div><br> 

      <div class="col-md-12 p1"><label class="labels">Email</label>: <?php echo $row['donoremail']?></div><br> 

      <div class="col-md-12 p1"><label class="labels">Outlet Name</label>: <?php echo $row['outletname']?></div><br>

      <div class="col-md-12 p1"><label class="labels">Type of Outlet</label>: <?php echo $row['outlet_type']?></div><br>
      
      <div class="col-md-12 p1"><label class="labels">Registration Number</label>: <?php echo $row['registrationnumber']?></div><br>

      <div class="col-md-12 p1"><label class="labels">Address</label>: <?php echo $row['donoraddress']?></div><br>

      <div class="col-md-12 p1"><label class="labels">City</label>: <?php echo $row['dcity']?></div><br>

      <div class="col-md-12 p1"><label class="labels">State</label>: <?php echo $row['dstate']?></div><br>

      <div class="col-md-12 p1"><label class="labels">Postcode</label>: <?php echo $row['dpostcode']?></div><br>

      <div class="col-md-12 p1"><label class="labels">Registered Date</label>: <?php echo $row['dateregist']?></div><br>
      </div>
    </form>
    <hr size="7" width="80%" color="yellow">  <br> <br>
    </div>
