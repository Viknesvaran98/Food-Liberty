 ...
 <div id="loader-wrapper">
        ...
        <div class="container">
            ...
            <div class="menu text-right">
                <ul>
                    ...
                    <li>
                        <a href="doneedetail.php" class="notification">Profile</a>
                    </li>
                    <li>
                        <a href="outletpage.php" class="notification mm-active">Available Donors</a>
                    </li>
                    <li>
    ...
    <section class="food-menu" id="recent">
        <div class="container">
         ...
         <h1 class="text-left">Available Donors</h1>
     ...
     <?php
        $query = $db->query("SELECT * FROM donors WHERE username=username");
      ...
      <p class="food-detail"><label>Posted food details: <a href="specifiedfooddetails.php?donor_ID=<?=$row['donor_ID']?>"> Here </label></a></p>
