...
<div id="preloader">
    ...
    <div class="app-container app-theme-white body-tabs-shadow fixed-sidebar fixed-header">
        <div class="app-header header-shadow">
                    ...
                    <div class="app-header__menu">
                        ...
                        <div class="app-sidebar__inner">
                            <ul class="vertical-nav-menu">
                                ...
                                <li>
                                    <a href="adminfoodlist.php" class="mm-active">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="main-card mb-3 card">
                                    <div class="card-header">Posted Food
            ...
            <th style="text-align:center;">Food Status</th>
			<th style="text-align:center;">Posted by</th>
			<th style="text-align:center;">Registration Number of Outlet</th>
			<th style="text-align:center;">Posted Time</th>
        ...
        $result=$conn->prepare("SELECT c.* , p.* FROM donors c,excessfood p WHERE c.donor_ID=p.donor_ID order by excessfood_ID DESC LIMIT $start_from, $per_page_record");
        $result->execute();
		for($i=0; $row = $result->fetch(); $i++){
	?>
		<tr>
			<td style="text-align:center;"><label><?php echo $row['excessfood_ID']; ?></label></td>
			<td style="text-align:center;"><img width="auto" src="images/<?php echo $row['excessfoodimage']?>" alt="food" width="250" height="100" /></td>
			<td style="text-align:center;"><label><?php echo $row['excessfoodname']; ?></label></td>
			<td style="text-align:center;"><label><?php echo $row['quantity']; ?></label></td>
            <!--<td style="text-align:center;"><label><?php echo $row['food_status']; ?></label></td> -->
			...
			<td style="text-align:center;"><label><a href="viewdonorbyadmin.php?donor_ID=<?=$row['donor_ID']?>"><?php echo $row['outletname']; ?> </a></label></td>
			<td style="text-align:center;"><label><?php echo $row['registrationnumber']; ?></label></td>
            <td style="text-align:center;"><label><?php echo date('H:i A, d/m/y',strtotime($row['postedtime'])); ?></label></td>
			<td style="text-align:center;"><label><?php echo $row['pickfrom']; ?> - <?php echo $row['pickby']; ?></label></td>
            <td class="text-align:center">

            <a href="editfoodbyadmin.php?excessfood_ID=<?=$row['excessfood_ID']?>" class="btn btn-success">Edit</a> <br><br> 
...
function excessfood_ID(excessfood_ID)
{
     if(confirm('Sure To Remove This Record ?'))
     {
        window.location.href='adminfoodlist.php?delete_id='+excessfood_ID;
     }
}
</script>
      ...
      <?php  
        ...
        $query = "SELECT COUNT(*) FROM excessfood";     
        $query_run = mysqli_query($connection,$query);   
    ...
    echo "</br>";     
        ...
        if($page>=2){   
            echo "<a href='adminfoodlist.php?page=".($page-1)."'>  Prev </a>";   
        }       
                   
        for ($i=1; $i<=$total_pages; $i++) {   
          if ($i == $page) {   
              $pagLink .= "<a class = 'active' href='adminfoodlist.php?page="  
                                                .$i."'>".$i." </a>";   
          }               
          else  {   
              $pagLink .= "<a href='adminfoodlist.php?page=".$i."'>   
                                                ".$i." </a>";     
          }   
        };     
        echo $pagLink;   
        ...
        if($page<$total_pages){   
            echo "<a href='adminfoodlist.php?page=".($page+1)."'>  Next </a>";   
        }   
...
<script>   
    ...
    {   
        ...
        window.location.href = 'adminfoodlist.php?page='+page;   
    }   
  </script>
</body>
</html>
