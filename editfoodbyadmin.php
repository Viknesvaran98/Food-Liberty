...
<div id="preloader">
    ...
    <div class="app-container app-theme-white body-tabs-shadow fixed-sidebar fixed-header">
        <div class="app-header header-shadow">
          ...
          <br><img width="170" class="rounded-circle"src="images/<?php echo $row['excessfoodimage']?>"  alt=""><br><br><br><br>
              <p class="food-menu-box"><mark><label>Food ID: <?php echo $row['excessfood_ID']; ?></label></mark></p>
              ...
              <div class="col-md-12"><label class="labels">Food Name</label><input type="text" class="form-control" name="excessfoodname" id="excessfoodname" value="<?php echo $row['excessfoodname']?>" placeholder= "Enter new name" required/></div><br> <br>
					    ...
					    <div class="col-md-12"><label class="labels">Quantity</label><input type="text" class="form-control" name="quantity" id="quantity" value="<?php echo $row['quantity']?>" placeholder= "Enter new quantity" required/></div><br> <br>
...
if(isset($_POST['update']))
{
  ...
  $food_status = $_POST['food_status'];
	...
	if ($query_run)
	{
		echo "<script> alert('Data Updated'); window.location = 'adminfoodlist.php' </script>";
	}
	else
	{
