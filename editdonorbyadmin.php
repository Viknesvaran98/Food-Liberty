                    ...
                    <div class="app-header__menu">
                        ...
                        <div class="app-sidebar__inner">
                            <ul class="vertical-nav-menu">
                                ...
                                <li>
                                    <a href="editdonorbyadmin.php" class="mm-active">
...
<center>
  ...
  <div class="food-menu-box">
      ...
      <div class="col-md-12"><label class="labels">City</label><input type="textarea" class="form-control" name="dcity" id="dcity" rows="4" cols="50" value ="<?php echo $row['dcity']?>"placeholder="Enter city" required/></div><br> <br>
...
if ($query_run)
{
echo "<script> alert('Data Updated'); window.location = 'admindonorlist.php' </script>";
}
else
{
