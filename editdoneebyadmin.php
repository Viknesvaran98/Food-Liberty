    ...
    <div class="app-container app-theme-white body-tabs-shadow fixed-sidebar fixed-header">
        <div class="app-header header-shadow">
          ...
          <div class="food-menu-box">
              ...
              <p class="food-menu-box"><mark><label>ID: <?php echo $row['donee_ID']; ?></label></mark></p>
              ...
              <div class="col-md-12"><label class="labels">Username</label><input type="text" class="form-control" name="doneeusername" id="doneeusername" value="<?php echo $row['doneeusername']?>" placeholder= "Enter new username" required/></div><br> <br>
					    ...
					    <div class="col-md-12"><label class="labels">Volunteer/Representative's Full Name</label><input type="text" class="form-control" name="fullname" id="fullname" value="<?php echo $row['fullname']?>" placeholder= "Enter new name" required/></div><br> <br>
							...
							<div class="col-md-12"><label class="labels">NGO Name</label><input type="text" class="form-control" name="ngoname" id="ngoname" value="<?php echo $row['ngoname']?>" placeholder = "Enter outlet name" required/></div><br> <br>
							
							<div class="col-md-12"><label class="labels">Registration Number</label><input type="text" class="form-control" name="ngoregistnum" id="ngoregistnum" value="<?php echo $row['ngoregistnum']?>" placeholder="Enter new registration number" required/></div><br> <br>

							<div class="col-md-12"><label class="labels">Address</label><input type="textarea" class="form-control" name="doneeaddress" id="doneeaddress" rows="4" cols="50" value ="<?php echo $row['doneeaddress']?>"placeholder="Enter new address" required/></div><br> <br>

                            <div class="col-md-12"><label class="labels">State</label><input type="text" class="form-control" name="city" id="city" value="<?php echo $row['city']?>" placeholder="Enter city" required/>
							</div><br> <br>
							...
							<div class="col-md-12"><label class="labels">Postcode</label><input type="text" class="form-control" name="postcode" id="postcode" value="<?php echo $row['postcode']?>" placeholder="Postcode" required/></div><br>

							<input type="hidden" name="dateregist" id="dateregist" value="<?php echo $row['dateregist']?>" placeholder="Postcode" required/>
              <p class="food-detail"><label>Registrated on: <mark><?php echo $row['dateregist']; ?></mark></label></p>
...
if(isset($_POST['update']))
{
	...
	$query = "UPDATE `donee` SET doneeusername ='$_POST[doneeusername]',doneeimage ='$_POST[doneeimage]',password ='$_POST[password]',donee_password ='$_POST[donee_password]',fullname ='$_POST[fullname]',ngoname ='$_POST[ngoname]',ngoregistnum ='$_POST[ngoregistnum]',email ='$_POST[email]',contact_num ='$_POST[contact_num]',doneeaddress ='$_POST[doneeaddress]',city ='$_POST[city]',state ='$_POST[state]',postcode ='$_POST[postcode]',dateregist ='$_POST[dateregist]' where doneeusername='$_POST[doneeusername]'";
	$query_run= mysqli_query($connection,$query);

	if ($query_run)
	{
		echo "<script> alert('Data Updated'); window.location = 'admindoneelist.php' </script>";
	}
	else
	{
