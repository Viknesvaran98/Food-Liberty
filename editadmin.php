...
<center>
  <form action = "" method="POST" >
      ...
      <br><img width="170" class="rounded-circle"src="images/adminwall7.png" alt=""><br><br>
      ...
      <div class="col-md-12"><label class="labels">Password</label><input type="text" class="form-control" name="password" id="password" value="<?php echo $row['password']?>" placeholder="Enter new password" required/></div><br> 

     <input type="hidden" name="donor_ID" id="donor_ID" value="<?php echo $row['donor_ID']?>"/>
    

    <div class="mt-5 text-center"><input type="submit" name="update" value="Update Data"></div><br>
    </form>
...
$query = "UPDATE `donors` SET username ='$_POST[username]',donorfullname ='$_POST[donorfullname]',password ='$_POST[password]' where username='$_POST[username]'";
$query_run= mysqli_query($connection,$query);

if ($query_run)
{
echo "<script> alert('Profile Updated'); window.location = 'editadmin.php' </script>";
}
else
{
