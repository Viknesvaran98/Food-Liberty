 ...
 <div id="preloader">
    ...
    <div class="app-container app-theme-white body-tabs-shadow fixed-sidebar fixed-header">
        <div class="app-header header-shadow">
                    ...
                    <div class="app-header__menu">
                        ...
                        <div class="app-sidebar__inner">
                            <ul class="vertical-nav-menu">
                                ...
                                <li>
                                    <a href="admindonorlist.php" class="mm-active">
                            ...
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    <div class="page-title-icon">
                                        <a href="donorgraphpage.php"><i class="pe-7s-graph3 icon-gradient bg-mean-fruit">
                                        </i></a>
                                    </div>
			...
			<th style="text-align:center;">Donor's Image</th>
			<th style="text-align:center;">Password</th>
			<th style="text-align:center;">Full Name</th>
			<th style="text-align:center;">Outlet Name</th>
      <th style="text-align:center;">Type of Outlet</th>
		...
		$result = $conn->prepare("SELECT * FROM donors WHERE usertype='1' ORDER BY dateregist DESC LIMIT $start_from, $per_page_record ");
		$result->execute();
		for($i=0; $row = $result->fetch(); $i++){
	?>
		<tr>
			<td style="text-align:center;"><label><?php echo $row['donor_ID']; ?></label></td>
			<td style="text-align:center;"><label><?php echo $row['username']; ?></label></td>
			<td style="text-center;"><img width="auto" src="images/<?php echo $row['donorimage']?>" alt="donor" width="250" height="100" /></td>
			<td style="text-align:center;"><label><?php echo $row['password']; ?></label></td>
			<td style="text-align:center;"><label><?php echo $row['donorfullname']; ?></label></td>
			<td style="text-align:center;"><label><?php echo $row['outletname']; ?></label></td>
      <td style="text-align:center;"><label><?php echo $row['outlet_type']; ?></label></td>
			<td style="text-align:center;"><label><?php echo $row['registrationnumber']; ?></label></td>
			<td style="text-align:center;"><label><?php echo $row['donoremail']; ?></label></td>
			<td style="text-align:center;"><label><?php echo $row['donorcontact_num']; ?></label></td>
			<td style="text-align:center;"><label><?php echo $row['donoraddress']; ?></label></td>
            <td style="text-align:center;"><label><?php echo $row['dcity']; ?></label></td>
			<td style="text-align:center;"><label><?php echo $row['dstate']; ?></label></td>
			<td style="text-align:center;"><label><?php echo $row['dpostcode']; ?></label></td>
      <td style="text-align:center;"><label><?php echo date('H:i A, d-m-Y',strtotime($row['dateregist'])); ?></label></td>
      <td class="text-align:center">

      <a href="editdonorbyadmin.php?donor_ID=<?=$row['donor_ID']?>" class="btn btn-success">Edit</a> <br><br>
                                                   
        <form action="donordelete.php" method="post">
...
function donor_ID(donor_ID)
{
     if(confirm('Sure To Remove This Record ?'))
     {
        window.location.href='admindonorlist.php?delete_id='+donor_ID;
     }
}
</script>
    ...
    echo "</br>";     
        ...
        if($page>=2){   
            echo "<a href='admindonorlist.php?page=".($page-1)."'>  Prev </a>";   
        }       
                   
        for ($i=1; $i<=$total_pages; $i++) {   
          if ($i == $page) {   
              $pagLink .= "<a class = 'active' href='admindonorlist.php?page="  
                                                .$i."'>".$i." </a>";   
          }               
          else  {   
              $pagLink .= "<a href='admindonorlist.php?page=".$i."'>   
                                                ".$i." </a>";     
          }   
        };     
        echo $pagLink;   
        ...
        if($page<$total_pages){   
            echo "<a href='admindonorlist.php?page=".($page+1)."'>  Next </a>";   
        }   
...
<script>   
    ...
    {   
        ...
        window.location.href = 'admindonorlist.php?page='+page;   
    }   
  </script> 
